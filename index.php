...
$name = "app_name"; // your application name
$ownerid = "ownerid"; // your KeyAuth account's ownerid, located in account settings 
    ...
    <?php
		...
		if($KeyAuthApp->license($_POST['key']))
		{
			echo "<meta http-equiv='Refresh' Content='2; url=customer/'>";
                            ...
                            ';     
							dashboard\primary\wh_log($logwebhook, "> login success", $webhookun);
		}
		}
